                    ...
                    if(isset($_POST['id'])){
                        ...
                        if ($_FILES && isset($_FILES["file"]["tmp_name"])) {
                            ...
                            if(isset($_POST["new_entry"])){
                                ...
                                if($image_id=="1"){
                                    $var = "`gig_img1`='$image_name'";
                                } elseif($image_id=="2"){
                                    $var = "`gig_img2`='$image_name'";
                                } elseif($image_id=="3"){
                                    $var = "`gig_img3`='$image_name'";
                                } elseif($image_id=="4"){
                                    $var = "`gig_img4`='$image_name'";
                                } elseif($image_id=="5"){
                                    $var = "`gig_img5`='$image_name'";
                                } else {
                                    $var = "`gig_img1`='$image_name'";
                                }
                                $upload_db=mysqli_query($con,"UPDATE `experience` SET ".$var." WHERE `id`='$id'");    
                            }
