...
if (isset($_POST["email"])){
        ...
        $msg = '<body style="border:1px solid darkgray;width:100%;height:fit-content;font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif;"><div style="padding: 1em;"><p>Thank you for subscribing to updates on PayPassion.in. We will keep you informed of regular updates. <br />One Community. One Talent.</p><h1 title="PayPassion | One Community, One Talent"><a title="PayPassion | One Community, One Talent" href="http://paypassion.in/" target="_blank"><img title="PayPassion | One Community, One Talent" alt="PayPassion - Mangalore’s Talent Community" src="http://paypassion.in/images/logo.jpg" width=\'300\' height=\'80\' /> </a></h1></div></body>';
	...
	<div class="footer">
		<div class="container">
			<div class="col-md-4 w3layouts_footer_grid"> 
				<div class="title">
					<h2 title="PayPassion | One Community, One Talent">Terms of use*</h2> 
				</div>
				<div class="social-icon social_agileinfo">
					<p>Please read these Terms of Use carefully before using or accessing the Site. These Terms of Use supersede any prior User Agreement and apply to all the gigsters, visitors and others who access the Service (“Users”).</p>
				</div> 
					<div class="more">
					<a title="PayPassion | One Community, One Talent" href="#" data-toggle="modal" data-target="#myModal1"> Read More</a>
					</div>	
			</div>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body modal-spa">
					<h3 title="PayPassion | One Community, One Talent">Terms of use</h3>
					<p>
...
Last Updated: November 14, 2017
			...
			<div class="col-md-8 w3layouts_footer_grid">
				...
				<ul class="w3l_footer_nav">
					<li><a title="PayPassion | One Community, One Talent"href="index.php" >Home</a></li> 
					<li><a title="PayPassion | One Community, One Talent"href="#about" class="scroll">About</a></li>
					<li><a title="PayPassion | One Community, One Talent"href="http://paypassion.in/paypassion/register.php" class="">Register</a></li>
					<li><a title="PayPassion | One Community, One Talent"href="#contact" class="scroll">Contact Us</a></li>	
				</ul> 
			</div>
			<div class="clearfix"> </div>
		</div>
	...
	<div class="footer-w3copy w3-agileits">
		<p>© 2017 PayPassion. All Rights Reserved | Designed by <span>Crazycodez</span></p>
	</div>
	<!-- //footer -->    
...
<script>
           ...
           var player;
            ...
            function onPlayerReady(event) {
                var playButton = document.getElementById("video_div");
                playButton.addEventListener("mouseover", function() {
                    player.playVideo();
                });
                var pauseButton = document.getElementById("video_div");
